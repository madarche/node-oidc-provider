...
const DRAFTS = new Map(Object.entries({
  ...
  issAuthResp: {
    name: 'OAuth 2.0 Authorization Server Issuer Identifier in Authorization Response - draft 02',
    type: 'Individual draft',
    url: 'https://tools.ietf.org/html/draft-meyerzuselhausen-oauth-iss-auth-resp-02',
    version: ['individual-draft-02'],
  },
}));
